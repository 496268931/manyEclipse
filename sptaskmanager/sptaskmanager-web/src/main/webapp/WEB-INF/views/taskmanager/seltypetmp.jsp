...
<link rel="stylesheet" href="${basePath}/static/css/pstyle.css" type="text/css" />
<link rel="stylesheet" href="${basePath}/static/css/jquery_datatables.css" type="text/css" />
<style>
...
<script type="text/javascript" src="${basePath}/static/js/createsptask/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="${basePath}/static/js/createsptask/jquery.jsPlumb-1.7.5-min.js"></script>
...
<script type="text/javascript" src="${basePath}/static/js/oldaddsptask/taskcanvas.js"></script>
...
<script type="text/javascript" src="${basePath}/static/js/createsptask/task.js"></script>
