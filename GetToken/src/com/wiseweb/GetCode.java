...
public class GetCode {
	static String clientId = "420227280";// 你的应用ID
	static String clientSecret = "4dc083db8d9f622a2171de54d5c39007";// 你的应用密码
	static String redirectUri = "www.sina.com";// 你在应用管理中心设置的回调页面
